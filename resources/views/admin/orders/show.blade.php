      ...
      <div class="card">
        ...
        <div class="card-body p-3 sticky-actions d-flex align-items-center justify-content-between">
          <div class="d-flex align-items-center gap-3">
            <a href="{{ route('admin.orders.all')}}" class="btn btn-outline-secondary btn-sm">← Back</a>
            <div>
          ...
          <div class="d-flex gap-2">
            <a class="btn btn-outline-dark btn-sm"
               href="{{ route('orders.slip', [$root->id, 'print' => 1, 'paper' => '80']) }}"
               target="_blank">
...
<script>
  function nextStatus(orderId){
    ...
    fetch(`/admin/data/orders/${orderId}/status`, {
      method:'PATCH',
  ...
  function cancelOrder(orderId){
    ...
    fetch(`/admin/data/orders/${orderId}/cancel`, {
      method:'POST',
      headers:{'Content-Type':'application/json','X-CSRF-TOKEN':'{{ csrf_token() }}'},
      body: JSON.stringify({})
    })
