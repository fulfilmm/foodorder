            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.tables.all') }}">Categories</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Create New Categories</li>
                    </ol>
                </nav>
            </div>
        </div>
                        ...
                        <form action="{{ route('admin.categories.store') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    ...
                                    <a href="{{ route('admin.categories.all') }}" class="btn btn-secondary px-4">Cancel</a>
                                </div>
                            </div>
                        </form>
                    </div>
