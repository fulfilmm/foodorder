        ...
        <div class="card forgot-box">
            <div class="card-body">
                <div class="p-4 rounded  border">
                    ...
                    <form action="{{ route('waiter.send_otp') }}" method="POST">
                        @csrf
                        <div class="my-4">
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <a href="{{ route('waiter.login') }}" class="btn btn-light btn-lg">
...
{{--                    </div>--}}
{{--                    <div class="d-grid gap-2">--}}
{{--                        <button type="button" class="btn btn-primary btn-lg">Send</button> <a href="{{route('waiter.login')}}" class="btn btn-light btn-lg"><i class='bx bx-arrow-back me-1'></i>Back to Login</a>--}}
{{--                    </div>--}}
                </div>
            </div>
        </div>
