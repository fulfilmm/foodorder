                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                           ...
                                           <a href="{{ route('manager.orders.slip', [$order->id, 'print' => 1, 'paper' => '80']) }}" class="btn btn-sm btn-success">Voucher Print</a>
                    <a href="{{route('manager.orders.show',[$order->id])}}" class="btn btn-sm btn-outline-info"><i class="bx bx-show"></i></a>
                                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function fetchStats(params) {
                ...
                fetch(`/manager/ajax-dashboard-stats?${query}`)
                    .then(res => res.json())
                    .then(data => {
