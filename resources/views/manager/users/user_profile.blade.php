        ...
        <div class="container">
            <div class="main-body">
                <div class="row">
                    ...
                    @endif
                    {{-- The edit form section, initially hidden --}}
                    <div class="col-lg-12" id="editUserForm" style="display: none;">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('manager.users.update', $user->id) }}" method="POST">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="role" class="form-control" name="role" value="{{ old('role', $user->role) }}" readonly/>
                                        </div>
                                    </div>
                                    <div class="row">
...
@section('custom-js')
<script>
    // Function to toggle the edit user form visibility
    function editUser() {
